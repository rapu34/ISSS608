...
![](images/clipboard-3521244695.png)
...
globalPop <- read_xls("/Users/jay/ISSS608-VAA/Hands-on_Ex/Hands_on_Ex04/data/GlobalPopulation.xls",
                      sheet="Data") %>%
  mutate_each_(funs(factor(.)), col) %>%
  mutate(Year = as.integer(Year))
```

![Unfortunately, `mutate_each_()` was deprecated in dplyr 0.7.0. and `funs()` was deprecated in dplyr 0.8.0. In view of this, we will re-write the code by using [`mutate_at()`](https://r4va.netlify.app/chap04) as shown in the code chunk below.](images/clipboard-1580228855.png)

```{r}
col <- c("Country", "Continent")
globalPop <- read_xls("/Users/jay/ISSS608-VAA/Hands-on_Ex/Hands_on_Ex04/data/GlobalPopulation.xls",sheet="Data") %>%
...
![](images/clipboard-174883998.png)
:::
